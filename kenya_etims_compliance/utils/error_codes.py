...
KRA_ERROR_CODES = {
	...
	"020": (
		"Duplicate data",
		"This transaction has already been submitted. Check for duplicate invoice numbers.",
	),
	...
	"040": (
		...
		"Check TIN, branch ID, and communication key in TIS Device Initialization.",
	),
	...
	"050": (
		"Item not registered",
		"Register the item with KRA using the Item Registration API before selling.",
	),
	...
	"060": (
		...
		"The invoice number sequence is incorrect. Check the last invoice number.",
	),
	...
	"900": (
		"Missing API headers",
		"No active TIS Device Initialization found for this branch. Check that the device is registered and active.",
	),
	# Device installation / re-initialization codes
	"902": (
		"Device already installed",
		"This device is already registered with KRA. No re-initialization needed. Verify device is online using selectOrgUsrInfo.",
	),
}
