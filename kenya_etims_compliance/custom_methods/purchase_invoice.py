    ...
    try:
        ...
        if "Success" in result:
            ...
            eTIMS.log_errors(
                ...
                f"Supplier: {doc.supplier}, Error: {error_msg}"
            )
...
def auto_verify_invoice(doc, method):
    ...
    if result.get("verified"):
        ...
        eTIMS.log_errors(
            f"Auto-verification failed for {doc.name}",
...
def mark_invoice_as_manually_verified(docname, reason):
    ...
    try:
        ...
        if doc.get("custom_invoice_verified"):
            return {
                "success": False,
                "message": "Invoice is already verified"
            }
        ...
        return {
            "success": True,
            "message": "Invoice marked as manually verified"
        }
