...
from kenya_etims_compliance.custom_methods.purchase_invoice import verify_supplier_invoice, mark_invoice_as_manually_verified
from kenya_etims_compliance.custom_methods.purchase_order import send_purchase_order_to_etims, reconcile_purchase_with_invoice
...
class TestEtimsExpenseCompliance(FrappeTestCase):
    ...
    def test_manual_invoice_verification(self):
        ...
        # Note: Full invoice creation requires items and taxes
        # This is a simplified test

        # Test manual verification
        result = mark_invoice_as_manually_verified(
            "TEST-INV-001",
            "Testing manual verification override"
        )
    ...
    def test_get_unpaid_invoices_summary(self):
        ...
        self.assertTrue("unverified_unpaid" in result or "verified_unpaid" in result or "total_unpaid" in result)
