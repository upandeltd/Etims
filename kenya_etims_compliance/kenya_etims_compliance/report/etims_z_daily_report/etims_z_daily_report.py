...
def get_data(filters):
    ...
    base_filters = {"si.docstatus": 1, "si.posting_date": report_date, "si.custom_update_invoice_in_tims": 1}
    ...
    if discount_data and discount_data[0].total_discount:
        data.append({"category": "DISCOUNTS", "description": "", "count": discount_data[0].cnt, "amount": discount_data[0].total_discount})
    else:
    ...
    data.append({"category": "Total Items Sold", "description": "", "count": int(item_count[0].total_items or 0) if item_count else 0, "amount": None})
